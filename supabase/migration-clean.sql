-- ============================================================
-- PeakSkills - Complete Database Migration (Clean Version)
-- No em dashes, no smart quotes - safe for Supabase SQL Editor
-- ============================================================
...
('Leadership Excellence Program', 'leadership-excellence-program',
 ...
 'Participants who complete all five days receive a Certificate of Completion in Leadership Excellence from PeakSkills.'),
...
('Professional Ethics & Workplace Conduct', 'professional-ethics-workplace-conduct',
 ...
 'All staff levels, from recent graduates to department heads. Particularly relevant for organizations with regulatory compliance obligations such as banks, government bodies, and NGOs.',
...
('Banking Operations & Regulatory Compliance', 'banking-operations-regulatory-compliance',
...
('Career Readiness for Youth', 'career-readiness-for-youth',
...
('Amina Shariff', 'Country Director', 'Oxfam Tanzania', 'NGO',
 'We needed a provider who could deliver ethics and governance training relevant to both our national and international staff - not generic compliance training. PeakSkills produced a program that engaged both groups and produced deep reflection. I would recommend them without hesitation to any development-sector organization.',
 5, true),
...
('Fatuma Ally', 'HR Manager', 'Tanzania Ports Authority', 'Government',
 'Professional development training for port operations staff is a challenge because our environment is very specific. PeakSkills took the time to understand our context before designing the program, and the result was material that our staff recognized and engaged with rather than dismissed as irrelevant.',
 4, false);
...
select 'programs'     as table_name, count(*) as rows from programs      union all
select 'cohorts'      as table_name, count(*) as rows from cohorts       union all
select 'testimonials' as table_name, count(*) as rows from testimonials  union all
